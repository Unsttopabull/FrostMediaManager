...
namespace Swordfish.NET.Collections {
    ...
    public class ConcurrentObservableCollection<T> : ConcurrentObservableBase<T>, IList<T>, IList {
        // ************************************************************************
        // Constructors
        // ************************************************************************
        ...
        public T this[int index] {
            get { return DoBaseRead(() => ReadCollection[index]); }
        ...
        public int Count {
            get { return DoBaseRead(() => ReadCollection.Count); }
        }

        public bool IsReadOnly {
            get { return DoBaseRead(() => ((ICollection<T>) ReadCollection).IsReadOnly); }
        }

        public bool Remove(T item) {
            return DoBaseWrite(() => WriteCollection.Remove(item));
        }
        ...
        bool ICollection.IsSynchronized {
            get { return DoBaseRead(() => ((ICollection) ReadCollection).IsSynchronized); }
        }

        object ICollection.SyncRoot {
            get { return DoBaseRead(() => ((ICollection) ReadCollection).SyncRoot); }
        }
        ...
        int IList.Add(object value) {
            return DoBaseWrite(() => ((IList) WriteCollection).Add(value));
        }
        ...
        int IList.IndexOf(object value) {
            return DoBaseRead(() => ((IList) ReadCollection).IndexOf(value));
        }
        ...
        bool IList.IsFixedSize {
            get { return DoBaseRead(() => ((IList) ReadCollection).IsFixedSize); }
        }

        bool IList.IsReadOnly {
            get { return DoBaseRead(() => ((IList) ReadCollection).IsReadOnly); }
        }
        ...
        object IList.this[int index] {
            get { return DoBaseRead(() => ((IList) ReadCollection)[index]); }
