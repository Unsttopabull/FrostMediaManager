...
namespace Swordfish.NET.Collections {
    ...
    public abstract class ConcurrentObservableBase<T> :
        ...
        /// </summary>
        private readonly ObservableCollectionViewModel<T> _viewModel;
        ...
        protected ConcurrentObservableBase(IEnumerable<T> enumerable) {
            ...
            IEnumerable<T> collection = enumerable as IList<T> ?? enumerable.ToList();

            _baseCollection = new ObservableCollection<T>(collection);
            _baseSnapshot = new ImmutableCollection<T>(collection);
        ...
        public IDisposable Subscribe(IObserver<NotifyCollectionChangedEventArgs> observer) {
            ...
            return DoBaseWrite(() => {
                ...
                return new DoDispose(() => DoBaseWrite(() => { _subscribers.Remove(key); }));
            });
        }
