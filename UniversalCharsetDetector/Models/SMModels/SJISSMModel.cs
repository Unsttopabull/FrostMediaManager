namespace Frost.SharpCharsetDetector.Models.SMModels {
    ...
    public class SjisSMModel : SMModel {
        ...
        public SjisSMModel() : base(
            new BitPackage(IndexShift.Shift4BITS, ShiftMask.Mask4BITS, BitShift.Shift4BITS, UnitMask.Mask4BITS, SjisCls),
            6,
            new BitPackage(IndexShift.Shift4BITS, ShiftMask.Mask4BITS, BitShift.Shift4BITS, UnitMask.Mask4BITS, SjisSt),
            SJISCharLenTable, 
            "Shift_JIS",
            932) {
        }
