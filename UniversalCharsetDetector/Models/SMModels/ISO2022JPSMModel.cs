namespace Frost.SharpCharsetDetector.Models.SMModels {
    ...
    public class ISO2022JpSMModel : SMModel {
        ...
        public ISO2022JpSMModel() : base(
            new BitPackage(IndexShift.Shift4BITS, ShiftMask.Mask4BITS, BitShift.Shift4BITS, UnitMask.Mask4BITS, ISO2022JpCls),
            10,
            new BitPackage(IndexShift.Shift4BITS, ShiftMask.Mask4BITS, BitShift.Shift4BITS, UnitMask.Mask4BITS, ISO2022JpSt),
