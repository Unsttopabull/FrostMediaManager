namespace Frost.SharpCharsetDetector.Models.SMModels {
    ...
    public class ISO2022CnSMModel : SMModel {
        ...
        public ISO2022CnSMModel() : base(
            new BitPackage(IndexShift.Shift4BITS, ShiftMask.Mask4BITS, BitShift.Shift4BITS, UnitMask.Mask4BITS, ISO2022CnCls),
            9,
            new BitPackage(IndexShift.Shift4BITS, ShiftMask.Mask4BITS, BitShift.Shift4BITS, UnitMask.Mask4BITS, ISO2022CnSt),
