    ...
    public class ISOCountryCodes : ISOCodes<ISOCountryCode> {
        ...
        static ISOCountryCodes() {
            ISOCountryCode[] icc = {
                ...
                new ISOCountryCode("Bahamas (the)", "BS", "BHS", 044),
                ...
                new ISOCountryCode("Bolivia, Plurinational State of", "BO", "BOL", 068),
                ...
                new ISOCountryCode("British Indian Ocean Territory (the)", "IO", "IOT", 086),
                ...
                new ISOCountryCode("Cayman Islands (the)", "KY", "CYM", 136),
                new ISOCountryCode("Central African Republic (the)", "CF", "CAF", 140),
                ...
                new ISOCountryCode("Cocos (Keeling) Islands (the)", "CC", "CCK", 166),
                ...
                new ISOCountryCode("Cook Islands (the)", "CK", "COK", 184),
                ...
                new ISOCountryCode("Falkland Islands (the) [Malvinas]", "FK", "FLK", 238),
                new ISOCountryCode("Faroe Islands (the)", "FO", "FRO", 234),
                ...
                new ISOCountryCode("French Southern Territories (the)", "TF", "ATF", 260),
                new ISOCountryCode("Gabon", "GA", "GAB", 266),
                new ISOCountryCode("Gambia (The)", "GM", "GMB", 270),
                ...
                new ISOCountryCode("Holy See (the) [Vatican City State]", "VA", "VAT", 336),
                ...
                new ISOCountryCode("Iran (the Islamic Republic of)", "IR", "IRN", 364),
                ...
                new ISOCountryCode("Korea (the Republic of)", "KR", "KOR", 410),
                new ISOCountryCode("Kuwait", "KW", "KWT", 414),
                new ISOCountryCode("Kyrgyzstan", "KG", "KGZ", 417),
                new ISOCountryCode("Lao People's Democratic Republic (the)", "LA", "LAO", 418),
                ...
                new ISOCountryCode("Macedonia (the former Yugoslav Republic of)", "MK", "MKD", 807),
                ...
                new ISOCountryCode("Marshall Islands (the)", "MH", "MHL", 584),
                ...
                new ISOCountryCode("Micronesia (the Federated States of)", "FM", "FSM", 583),
                new ISOCountryCode("Moldova (the Republic of)", "MD", "MDA", 498),
                ...
                new ISOCountryCode("Netherlands (the)", "NL", "NLD", 528),
                ...
                new ISOCountryCode("Philippines (the)", "PH", "PHL", 608),
                ...
                new ISOCountryCode("Russian Federation (the)", "RU", "RUS", 643),
                ...
                new ISOCountryCode("Solomon Islands (the)", "SB", "SLB", 090),
                ...
                new ISOCountryCode("Sudan (the)", "SD", "SDN", 729),
                ...
                new ISOCountryCode("Syrian Arab Republic (the)", "SY", "SYR", 760),
                ...
                new ISOCountryCode("Turks and Caicos Islands (the)", "TC", "TCA", 796),
                new ISOCountryCode("Tuvalu", "TV", "TUV", 798),
                new ISOCountryCode("Uganda", "UG", "UGA", 800),
                new ISOCountryCode("Ukraine", "UA", "UKR", 804),
                new ISOCountryCode("United Arab Emirates (the)", "AE", "ARE", 784),
                new ISOCountryCode("United Kingdom (the)", "GB", "GBR", 826),
                new ISOCountryCode("United States (the)", "US", "USA", 840),
                new ISOCountryCode("United States Minor Outlying Islands (the)", "UM", "UMI", 581),
