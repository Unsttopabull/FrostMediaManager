...
namespace Frost.Common.Util.ISO {
    ...
    public class ISOLanguageCode : ISOCode {
        ...
        internal ISOLanguageCode(string englishName, string alpha2, string alpha3B, string alpha3T = null) : base(englishName, alpha2, alpha3B) {
        ...
        internal ISOLanguageCode(string alpha2, string alpha3B, string alpha3T, params string[] languageNames) : base(languageNames.Length != 0 ? languageNames[0] : null, alpha2, alpha3B) {
            Alpha3Terminology = alpha3T;
