...
namespace Frost.Common.Models.DB.MovieVo.ISO {
    ...
    public class ISO3166_1 {
        ...
        /// <summary>Initializes a new instance of the <see cref="ISO3166_1" /> class.</summary>
        public ISO3166_1() {
        }

        /// <summary>Initializes a new instance of the <see cref="ISO3166_1" /> class.</summary>
        /// <param name="countryName">The english country name.</param>
        public ISO3166_1(string countryName) {
        ...
        public ISO3166_1(string alpha2, string alpha3) {
            Alpha2 = alpha2;
            Alpha3 = alpha3;
        }
