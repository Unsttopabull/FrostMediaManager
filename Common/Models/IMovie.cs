...
namespace Frost.Common.Models {
    ...
    public interface IMovie : IMovieEntity {
        ...
        ICollection<IStudio> Studios { get; }
        ...
        ICollection<IRating> Ratings { get; }
        ...
        ICollection<ISpecial> Specials { get; }

        /// <summary>Gets or sets the movie genres.</summary>
        /// <value>The movie genres.</value>
        ICollection<IGenre> Genres { get; }

        ICollection<IAward> Awards { get; }

        ICollection<IPromotionalVideo> PromotionalVideos { get; }
