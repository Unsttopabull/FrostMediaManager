...
namespace Common.Models.XML.XBMC {
    ...
    public class XbmcXmlVideoInfo {
        ...
        /// <summary>Converts an instance of <see cref="XbmcXmlVideoInfo"/> to an instance of <see cref="Common.Models.DB.MovieVo.Files.Video">Video</see>.</summary>
        /// <param name="video">The video instance to convert.</param>
        /// <returns>An instance of <see cref="Common.Models.DB.MovieVo.Files.Video">Video</see> converted from <see cref="XbmcXmlVideoInfo"/></returns>
