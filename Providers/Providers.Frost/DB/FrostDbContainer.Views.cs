...
[assembly: DbMappingViewCacheTypeAttribute(typeof(Frost.Providers.Frost.DB.FrostDbContainer), typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySetsa6080751efd581d970efc63cb0408dca4778e1368899f9ca3bef6daa996477a0))]
namespace Edm_EntityMappingGeneratedViews {
    ...
    internal sealed class ViewsForBaseEntitySetsa6080751efd581d970efc63cb0408dca4778e1368899f9ca3bef6daa996477a0 : DbMappingViewCache {
        /// <summary>
        /// Gets a hash value computed over the mapping closure.
        /// </summary>
        public override string MappingHashValue {
            get { return "a6080751efd581d970efc63cb0408dca4778e1368899f9ca3bef6daa996477a0"; }
        }
        ...
        public override DbMappingView GetView(EntitySetBase extent) {
            ...
            if (extentName == "CodeFirstDatabase.Actors") {
                return GetView0();
            }
        ...
        /// <summary>
        /// Gets the view for CodeFirstDatabase.Actors.
        /// </summary>
        /// <returns>The mapping view.</returns>
        private static DbMappingView GetView0() {
            return new DbMappingView(@"
                SELECT VALUE -- Constructing Actors
                    [CodeFirstDatabaseSchema.Actors](T1.Actors_PersonId, T1.Actors_Character, T1.Actors_MovieId)
                FROM (
                    SELECT 
                        T.PersonId AS Actors_PersonId, 
                        TREAT(T AS [Frost.Providers.Frost.DB.Actor]).Character AS Actors_Character, 
                        TREAT(T AS [Frost.Providers.Frost.DB.Actor]).MovieId AS Actors_MovieId, 
                        True AS _from0
                    FROM FrostDbContainer.People AS T
                    WHERE T IS OF (ONLY [Frost.Providers.Frost.DB.Actor])
                ) AS T1"
            );
        }
        ...
        private static DbMappingView GetView1() {
            return new DbMappingView(@"
                SELECT VALUE -- Constructing Person
                    [CodeFirstDatabaseSchema.Person](T1.Person_PersonId, T1.Person_Name, T1.Person_Thumb, T1.Person_ImdbID)
                FROM (
                    SELECT 
        ...
        private static DbMappingView GetView21() {
            return new DbMappingView(@"
                ...
                FROM (
                    SELECT 
                        Key(T.Person_MoviesAsDirector_Source).PersonId AS PersonMovie_DirectorId, 
        ...
        private static DbMappingView GetView22() {
            return new DbMappingView(@"
                ...
                FROM (
                    SELECT 
                        Key(T.Person_MoviesAsWriter_Source).PersonId AS PersonMovie1_WriterId, 
        ...
        private static DbMappingView GetView26() {
            return new DbMappingView(@"
                SELECT VALUE -- Constructing People
                    CASE
                        WHEN NOT(T3._from1) THEN [Frost.Providers.Frost.DB.Person](T3.Person_PersonId, T3.Person_Name, T3.Person_Thumb, T3.Person_ImdbID)
                        ELSE [Frost.Providers.Frost.DB.Actor](T3.Person_PersonId, T3.Person_Name, T3.Person_Thumb, T3.Person_ImdbID, T3.Actor_Character, T3.Actor_MovieId)
                    END
                FROM (
                    SELECT T1.Person_PersonId, T1.Person_Name, T1.Person_Thumb, T1.Person_ImdbID, T2.Actor_Character, T2.Actor_MovieId, T1._from0, (T2._from1 AND T2._from1 IS NOT NULL) AS _from1
                    FROM  (
                        SELECT 
                            T.PersonId AS Person_PersonId, 
                            T.Name AS Person_Name, 
                            ...
                            T.ImdbID AS Person_ImdbID, 
                            True AS _from0
                        FROM CodeFirstDatabase.Person AS T) AS T1
                        LEFT OUTER JOIN (
                        SELECT 
                            T.PersonId AS Person_PersonId, 
                            ...
                            True AS _from1
                        FROM CodeFirstDatabase.Actors AS T) AS T2
            ...
            return new DbMappingView(@"
                ...
                FROM (
                    SELECT -- Constructing Person_MoviesAsDirector_Source
                        CreateRef(FrostDbContainer.People, row(T2.[Person_MoviesAsDirector.Person_MoviesAsDirector_Source.PersonId]), [Frost.Providers.Frost.DB.Person]) AS [Person_MoviesAsDirector.Person_MoviesAsDirector_Source], 
                        T2.[Person_MoviesAsDirector.Person_MoviesAsDirector_Target]
                    FROM (
                        SELECT -- Constructing Person_MoviesAsDirector_Target
                            T1.[Person_MoviesAsDirector.Person_MoviesAsDirector_Source.PersonId], 
                        ...
                        FROM (
                            SELECT 
                                T.DirectorId AS [Person_MoviesAsDirector.Person_MoviesAsDirector_Source.PersonId], 
            ...
            return new DbMappingView(@"
                ...
                FROM (
                    SELECT -- Constructing Person_MoviesAsWriter_Source
                        CreateRef(FrostDbContainer.People, row(T2.[Person_MoviesAsWriter.Person_MoviesAsWriter_Source.PersonId]), [Frost.Providers.Frost.DB.Person]) AS [Person_MoviesAsWriter.Person_MoviesAsWriter_Source], 
                        T2.[Person_MoviesAsWriter.Person_MoviesAsWriter_Target]
                    FROM (
                        SELECT -- Constructing Person_MoviesAsWriter_Target
                            T1.[Person_MoviesAsWriter.Person_MoviesAsWriter_Source.PersonId], 
                        ...
                        FROM (
                            SELECT 
                                T.WriterId AS [Person_MoviesAsWriter.Person_MoviesAsWriter_Source.PersonId], 
